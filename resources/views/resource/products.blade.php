      ...
      <div class="row">
        ...
        <div class="col-md-6" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">
          <div class="right-content">
            <span style="font-family:monospace; color:white; background:#005555; padding:4px 10px; font-size:20px; border-radius: 10px; font-weight:bold;"> {{$ankara['name']}} </span>
            <h6 style="color:black;"> Price - <element style="color:brown;">N{{$ankara['price']}}</element> per yard</h6>
            <p>{{$ankara['description']}}<p>
            <span> <element style="background-image: url('/assets/ankara/green2.jpg'); color:white; border-radius:8px; padding:5px; "> {{$ankara['number']}}</element> left on stock </span>
              ...
              <input name="price" type="text" class="quantity-text" id="quantity" value="{{$ankara['price']}}" style="display:none;">
              <input name="image" type="text" class="quantity-text" id="quantity" value="{{$ankara->image}}" style="display:none;">
            ...
            <div class="down-content">
              <div class="categories">
                <h6>Category: <span><a href="/allproducts">{{$ankara->name}}</a></span></h6>
              </div>
              <div class="share">
