      ...
      <div class="row">
        ...
        <div class="col-md-6" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">
          <div class="right-content">
            <span style="font-family:monospace; color:white; background-color:#005555; padding:4px 10px; font-size:20px; border-radius: 10px; font-weight:bold;"> {{$adire['name']}} </span>
            <h6 style="color:black;"> Price - <element style="color:brown;">N{{$adire['price']}}</element> per yard</h6>
            <p>{{$adire['description']}}<p>
            <span> <element style="background-image: url('/assets/ankara/green2.jpg'); color:white; border-radius:8px; padding:5px; "> {{$adire['number']}}</element> left on stock </span>
              ...
              <input name="price" type="text" class="quantity-text" id="quantity" value="{{$adire['price']}}" style="display:none;">
              <input name="image" type="text" class="quantity-text" id="quantity" value="{{$adire->image}}" style="display:none;">
            ...
            <div style="display: flex; align-items:center;">
              ...
              <div style="">
              <span style="color:white; background-color:#005555; padding:7px; font-weight:bold; border-radius:10px;"> PROMOTIONS </span>
            ...
            <div class="down-content">
              <div class="categories">
                <h6>Category: <span><a href="/allproducts">{{$adire->name}}</a></span></h6>
              </div>
              <div class="share">
        ...
        <div class="col-md-6" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">
          <div class="right-content">
            ...
            <div class="down-content">
              ...
              <div class="share">
                <h6>Share: <span><a href="#"><i class="fa fa-facebook" style="background-color:#005555;"></i></a>
                <a href="#"><i class="fa fa-linkedin" style="background-color:#005555;"></i></a>
                <a href="#"><i class="fa fa-twitter" style="background-color:#005555;"></i></a></span></h6>
              </div>
