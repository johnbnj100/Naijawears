...
<div style="margin-top:13vh;">
    ...
    <div class="" style="margin-top: 30px;">
        <input type="text"  class="name" value="{{ $accounts->total }}" placeholder="Amount" name="amount" style="color: black; font-weight:bold;" required>
    </div>
...
<div id="test" class="morphbutton-content" style="border-radius:10px; margin-top:40px; background:lightgray; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">
    <div style="display:flex; justify-content:space-around; align-items:center; padding:20px 0px; background-image: url('/assets/ankara/green2.jpg');">
     ...
     <ul style="list-style:none; text-align:center; padding:10px;">
         @foreach ($account as $accounts)
         <li style=""><element style="font-weight:bold;">Amount:</element> {{ $accounts->total }} </li>
         @endforeach
