...
<form action="{{ route('adirestore') }}" method="POST" enctype="multipart/form-data" style="margin-top: 14vh; margin-bottom: 14vh; text-align: center;">
@csrf
...
<div class="create" style="text-align: center; margin: 30px 0px;">
    ...
    <button class="lace" style="background:#005555; border:1px solid white; border-radius: 10px;"><a href="{{ route('createlace') }}" style="color: white;"> Lace </a></button>
</div>
